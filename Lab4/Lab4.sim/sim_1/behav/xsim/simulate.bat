...
REM
REM Generated by Vivado on Thu Sep 24 19:36:18 -0500 2026
...
call xsim  tb_multiplier_behav -key {Behavioral:sim_1:Functional:tb_multiplier} -tclbatch tb_multiplier.tcl -log simulate.log
