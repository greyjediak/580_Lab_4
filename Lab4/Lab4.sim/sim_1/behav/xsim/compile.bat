...
REM
REM Generated by Vivado on Thu Sep 24 19:36:14 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_multiplier_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_multiplier_vlog.prj -log xvlog.log
