...
REM
REM Generated by Vivado on Thu Sep 24 22:53:51 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_multiplier_ext_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_multiplier_ext_vlog.prj -log xvlog.log
