...
HD_PWD='C:/Documents/2026 Fall UA/ECE 580/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_top_ext.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_top_ext.tcl -notrace
