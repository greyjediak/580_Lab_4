...
HD_PWD='C:/Documents/2026 Fall UA/ECE 580/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_top_ext.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_top_ext.tcl
